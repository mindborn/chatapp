                    ...
                    else
                    {
                        if (userType === 'agent') {
                            ...
                            mongo.MongoDBQuery('agentlogin', { token: token }, (docs) => {
                                ...
                                connection.sendUTF(
                                    JSON.stringify({ type: 'color', data: userColor, agent: agent }));
                                console.log((new Date()) + ' User is known as: ' + agent
                                    + ' with ' + userColor + ' color.');
                                console.log("userName in agent" + agent);
                                if (user=== false) {
                        ...
                        console.log("Rvr" + user);
                        if (agent !== false && user !== false) {
